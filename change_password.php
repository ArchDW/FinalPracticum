...
if (isset($_POST['update'])) {
  ...
  if (empty($errors)) {
      if (sha1($_POST['old-password']) !== current_user()['password']) {
        ...
        redirect('change_password.php?user=' . $_GET['user'], false);
      }
      $id = (int) $_POST['id'];
...
<div class="login-page">
  ...
  <?php echo display_msg($msg); ?>
    <form method="post" action="change_password.php?user=<?php echo $_GET['user']; ?> " class="clearfix">
      ...
      <div class="form-group clearfix">
        ...
        <a href="edit_account.php?user=<?php echo $_GET['user']; ?>" class="btn btn-default btn-danger">Cancelar</a>
      </div>
    </form>
</div>
