      ...
      if (move_uploaded_file($_FILES['file_upload']['tmp_name'], $upload)) { //movemos el archivo a su ubicacion 
        foreach ($_POST['docentes'] as $docentes) :
          ...
          if ($db->query($query)) {
            ...
            redirect('add_biblioteca_alumno.php?user=' . $_GET['user'], false);
          }
        endforeach;
        redirect('add_biblioteca_alumno.php?user=' . $_GET['user'], false);
      }else {
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="row">
          ...
          <div class="col-md-8">
            <form class="form" action="add_biblioteca_alumno.php?user=<?php echo $_GET['user'] ?>" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <a href="biblioteca_tut_pro_alumnos.php?user=<?php echo $_GET['user']; ?>" class="btn btn-default btn-danger">Cancelar</a>
              </div>
            </form>
          </div>
        </div>
