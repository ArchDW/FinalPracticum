                        ...
                        <?php foreach ($alumnos as $alumnos) : ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <a href="add_reflexion_alumno.php?id=<?php echo $alumnos['id']; ?>&user=<?php echo $_GET['user']; ?>" class="btn btn-success btn-xs" title="Preguntas de Orientación" data-toggle="tooltip">
