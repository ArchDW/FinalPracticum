<?php
  $page_title = 'Lista de Archivos para las Asesorias de Titulación';
  require_once('includes/load.php');
  // Checkin What level user has permission to view this page
page_require_level(3);
  $alumnos = join_biblioteca_ase_tit_alumno($_GET['user']);
?>
      ...
      <div class="panel panel-default">
        <div class="panel-heading clearfix">
         <div class="pull-right">
            <a href="add_biblioteca_ase_alumno.php?user=<?php echo $_GET['user']; ?>" class="btn btn-primary">Agregar Archivo</a>
         </div>
         <div class="pull-left">
