...
if (isset($_POST['add_sesiones_acuerdo'])) {
    if (empty($errors)) {
        ...
        if ($db->query($query)) {
            ...
            redirect('add_sesiones_acuerdo.php?user=' . $_GET['user'] . '&id=' . $_GET['id'], false);
        } else {
            //failed
...
<div class="row">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="col-md-6">
                <form method="post" action="add_sesiones_acuerdo.php?user=<?php echo $_GET['user']; ?>&id=<?php echo $_GET['id']; ?>">
