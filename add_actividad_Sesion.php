...
if (isset($_POST['add_actividad'])) {
    if (empty($errors)) {
        ...
        $matriculas = remove_junk($db->escape($_GET['m']));
        ...
        if ($db->query($query)) {
            ...
            redirect('add_actividad_Sesion.php?user=' . $_GET['user'], false);
        } else {
            //failed
...
<div class="row">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="col-md-6">
                <form method="post" action="add_actividad_Sesion.php?user=<?php echo $_GET['user']; ?>&m=<?php echo $_GET['m']; ?>">
